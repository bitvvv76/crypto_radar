...
def main():
    ...
    elif in_progress_pairs or not_checked_pairs:
        print("Текущий цикл наблюдений продолжается.")
        print(f"Полностью проверено идей: {len(completed_pairs)}")
        print(f"В процессе проверки: {len(in_progress_pairs)}")
        print(f"Не проверялись: {len(not_checked_pairs)}")
        print("Следующий шаг: завершить текущую очередь проверок.")

    else:
        print("Текущий цикл наблюдений завершён.")
        print(f"Полностью проверено идей: {len(completed_pairs)}")
